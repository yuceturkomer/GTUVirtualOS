#############################################################################
# Makefile for building: dist/Debug/GNU-Linux/VirtualOperatingSystem
...
QMAKE_TARGET  = VirtualOperatingSystem
DESTDIR       = dist/Debug/GNU-Linux/#avoid trailing-slash linebreak
TARGET        = dist/Debug/GNU-Linux/VirtualOperatingSystem
...
dist: 
	@test -d build/Debug/GNU-Linux/VirtualOperatingSystem1.0.0 || mkdir -p build/Debug/GNU-Linux/VirtualOperatingSystem1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux/VirtualOperatingSystem1.0.0/ && $(COPY_FILE) --parents MailBox.h VirtualOperatingSystemForm.h build/Debug/GNU-Linux/VirtualOperatingSystem1.0.0/ && $(COPY_FILE) --parents MailBox.cpp.cc VirtualOperatingSystemForm.cpp.cc main.cpp build/Debug/GNU-Linux/VirtualOperatingSystem1.0.0/ && $(COPY_FILE) --parents MailBox.ui VirtualOperatingSystemForm.ui build/Debug/GNU-Linux/VirtualOperatingSystem1.0.0/ && (cd `dirname build/Debug/GNU-Linux/VirtualOperatingSystem1.0.0` && $(TAR) VirtualOperatingSystem1.0.0.tar VirtualOperatingSystem1.0.0 && $(COMPRESS) VirtualOperatingSystem1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux/VirtualOperatingSystem1.0.0`/VirtualOperatingSystem1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux/VirtualOperatingSystem1.0.0
...
moc_VirtualOperatingSystemForm.cpp: ui_VirtualOperatingSystemForm.h \
	...
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) $(INCPATH) -I/usr/include/c++/4.8 -I/usr/include/x86_64-linux-gnu/c++/4.8 -I/usr/include/c++/4.8/backward -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include VirtualOperatingSystemForm.h -o moc_VirtualOperatingSystemForm.cpp
